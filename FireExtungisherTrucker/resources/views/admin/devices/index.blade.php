    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-lg font-semibold">{{ __('Device List') }}</h3>
                <a href="{{ route('locations.devices.create', $location->id) }}" class="hover:underline">
                ...
                <table class="min-w-full hidden md:table divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    @forelse ($devices as $device)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $device->position ?? '-' }}</td>

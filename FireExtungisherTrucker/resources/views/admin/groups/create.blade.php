<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Add New Group for') }} {{ $location->name }}
        </h2>
    </x-slot>
    ...
    <!-- Forma za dodavanje grupe -->
    <div class="max-w-7xl mx-auto">
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
            <form action="{{ route('locations.groups.store', $location->id) }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full border-gray-300 dark:border-gray-600 rounded p-2 dark:bg-gray-700 dark:text-white">{{ old('description') }}</textarea>
                </div>
